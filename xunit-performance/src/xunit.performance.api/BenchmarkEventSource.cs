...
namespace Microsoft.Xunit.Performance
{
    ...
    public sealed class BenchmarkEventSource : EventSource
    {
        ...
        public void BenchmarkIterationStart(string RunId, string BenchmarkName, int Iteration)
        {
            if (s_csvWriter != null)
        ...
        public void BenchmarkIterationStop(string RunId, string BenchmarkName, int Iteration, long AllocatedBytes = 0 /*dummy value for the TraceParserGen tool*/)
        {
            if (IsEnabled())
            {
                if (RunId == null)
        ...
        public void BenchmarkStart(string RunId, string BenchmarkName)
        {
            if (s_csvWriter != null)
        ...
        public void BenchmarkStop(string RunId, string BenchmarkName, string StopReason)
        {
            if (IsEnabled())
            {
                if (RunId == null)
